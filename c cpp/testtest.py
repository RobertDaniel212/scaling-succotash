...
def pause_menu():
    # create a font object and render text to display on the pause menu
    font = pygame.font.SysFont(None, 50)
    text = font.render("Paused", True, (255, 255, 255))

    # create a rectangle to display the text on
    text_rect = text.get_rect(center=(window_width/2, window_height/2))

    # create a surface to display the pause menu on
    pause_surface = pygame.Surface((window_width, window_height), pygame.SRCALPHA)
    pause_surface.fill((30, 30, 30, 100))

    # blit the text onto the surface
    pause_surface.blit(text, text_rect)

    # blit the pause surface onto the main surface
